...
import slideImage from "../../assets/img/slide-1.jpg";
...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    console.log(imageUrl, uploadImage.profileImage)
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              {/* <img src={`${data.profileImage}/users/1695637704121-images.jpeg`} alt="profile" /> */}
              {/* <img src={`${baseUrl}/getUserRecord/${data.profileImage}/{users/1695637704121-images.jpeg}`} alt="profile" /> */}
              <img src={`${imageUrl}/${uploadImage.profileImage}`} alt="profile" />
