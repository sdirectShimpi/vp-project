...
import userThree from "../../images/user/user-03.png";
import { getActions } from "../../store/slice/getDetails.slice";
import { uplodeActions } from "../../store/slice";
...
const Settings = () => {
  ...
  const getfromUser = async () => {
    ...
    if (getActions.getRecord.fulfilled.match(response)) {
      ...
      toast.error("An error occurred while getData.");
    }
  };
  ...
  const uplodeImage = async () => {
    ...
    if (uplodeActions.uplodeRecord.fulfilled.match(response)) {
      // setFile({ profileImage: response.payload.data.data.profileImage });
      console.log("setFileImage", response);
    } else {
      toast.error("An error occurred while getData.");
    }
  };
              ...
              <div className="p-7">
                <form action="#">
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <img src={`${imageUrl}/${state.profileImage}`} alt="profile" />

                      {/* <img src={file ? file : userThree} alt="User" /> */}
                      {/* <img src={file.profileImage}/> */}
                    </div>
                    <div>
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center justify-center space-y-3">
                      ...
                      <p>
                        <span type="file" className="text-primary">
                          Click to upload
                        </span>{" "}
                        or drag and drop
                      </p>
