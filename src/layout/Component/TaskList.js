...
taskList2:""
    ...
    //         e.preventDefault();
    //         const response = await axios.post(`${baseUrl}/addmyTask`, createTask);
    ...
    const addTaskList = async (e) => {
        try {
            ...
            // Check if taskName, taskDescription, and assignDate are not empty
            if (!createTask.taskName || !createTask.taskDescription || !createTask.assignDate) {
    ...
    return (
      ...
      />
                ...
                <label for="taskTitle" class="mb-2.5 block font-medium text-black dark:text-white">Task title</label>
                            <input type="text" name="taskName"  value={createTask.taskName} id="taskTitle" placeholder="Enter task title" class="w-full rounded-sm border border-stroke bg-white py-3 px-4.5 focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-boxdark dark:focus:border-primary" onChange={handlecrateUser} />
                        </div>

                        <div class="mb-5">
                            <label for="taskDescription" class="mb-2.5 block font-medium text-black dark:text-white">Task description</label>
                            <textarea name="taskDescription" value={createTask.taskDescription} onChange={handlecrateUser} id="taskDescription" cols="30" rows="7" placeholder="Enter task description" class="w-full rounded-sm border border-stroke bg-white py-3 px-4.5 focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-boxdark dark:focus:border-primary"></textarea>
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="flex flex-col gap-3.5">
                                <div class="flex items-center gap-2.5">
                                    <input type="text" name="taskList" value={createTask.taskList} onChange={handlecrateUser} id="taskList" placeholder="Enter list text" class="w-full rounded-sm border border-stroke bg-white py-3 px-4.5 focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-boxdark dark:focus:border-primary" />
...
2
                                ...
                                <div class="flex items-center gap-2.5">
                                    <input type="text"  name="taskList1" value={createTask.taskList1} onChange={handlecrateUser}  id="taskList" placeholder="Enter list text" class="w-full rounded-sm border border-stroke bg-white py-3 px-4.5 focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-boxdark dark:focus:border-primary" />
                                ...
                                <div class="flex items-center gap-2.5">
                                    <input type="text" name="taskList2" value={createTask.taskList2}  onChange={handlecrateUser}id="taskList" placeholder="Enter list text" class="w-full rounded-sm border border-stroke bg-white py-3 px-4.5 focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-boxdark dark:focus:border-primary" />
                    ...
                    />
                        ...
                        <button class="flex w-full items-center justify-center gap-2 rounded bg-primary py-2.5 px-4.5 font-medium text-white" onClick={addTaskList}>
                            <svg class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
